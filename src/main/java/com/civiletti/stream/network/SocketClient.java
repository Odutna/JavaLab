...
//        PrintWriter outputStream = null;
        ...
        try(
                ...
                PrintWriter outputStream = new PrintWriter(new DataOutputStream(clientSocket.getOutputStream()));
                ) {
            ...
            // Legge tutte le righe provenienti dal server e le visualizza sullo schermo
